...
SECRET_KEY = 'django-insecure-m7s@k)+vqexlsbhiu=b$l0c3jdd0g@wk%hl+&l4%fktr6fmxg6'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'machinetest',                  # Your database name
        'USER': 'root',                # Your MySQL username
        'PASSWORD': '9930duke200',            # Your MySQL password
